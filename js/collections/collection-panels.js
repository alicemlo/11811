    ...
    content: [
      {
        ...
        text: 'Künstlich intelligente Systeme können Abweichungen in einer Menge von Datensätzen gut erkennen. In der Radiologie kann diese Mustererkennung sehr hilfreich sein, krankhafte Veränderungen (bsp. Tumore) auf Bildern zu identifizieren.'
      },
      {
  ...
  <g id="clustering">
    ...
    <g id="g1-4" data-name="g1">
      ...
      },
      {
        ...
        text: 'Mit dieser Methode können Abweichungen in grossen Datensätzen identifiziert werden. Das ist zum Beispiel hilfreich in der Radiologie bei der Erkennung von Tumoren oder im Web, um betrügerische Inhalte zu erkennen (Bsp. Spam Mails).',
        image: `
